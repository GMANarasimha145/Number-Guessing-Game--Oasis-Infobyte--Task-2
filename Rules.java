...
public class Rules extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Computer will Generate a number called Goal Number which is in between 1 & 100");

        jLabel4.setFont(new java.awt.Font("Sylfaen", 0, 15)); // NOI18N
        jLabel4.setText("After that, Player has to predict a number called Play Number");

        jLabel5.setFont(new java.awt.Font("Sylfaen", 0, 15)); // NOI18N
        jLabel5.setText("If the Play Number is Equal to Goal Number then the Player Won the Game");

        jLabel7.setFont(new java.awt.Font("Sylfaen", 0, 15)); // NOI18N
        jLabel7.setText("The Game should be Attempted in the 5 attempts");

        jLabel2.setFont(new java.awt.Font("Sylfaen", 0, 24)); // NOI18N
        jLabel2.setText("Rules of NG Game");
